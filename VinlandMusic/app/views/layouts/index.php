    ...
    <div class="main-container">
        <header class="player-bar">
            ...
            <?php if (\app\models\Users::isUserLoggedIn()) : ?>
                <a href="/KursovaBE/VinlandMusic/users/logout">Logout</a>
            <?php else : ?>
                <?php if(\app\models\Users::isLoginPage()): ?>
                    <a href="/KursovaBE/VinlandMusic/users/register">Register</a>
                <?php elseif(\app\models\Users::isRegisterPage()): ?>
                    <a href="/KursovaBE/VinlandMusic/users/login">Login</a>
                <?php else: ?>
                    <a href="/KursovaBE/VinlandMusic/users/login">Login</a>
                    <a href="/KursovaBE/VinlandMusic/users/register">Register</a>
                <?php endif; ?>
            <?php endif; ?>
            <a href="/KursovaBE/VinlandMusic">Home</a>
        </header>
        <main class="main">
